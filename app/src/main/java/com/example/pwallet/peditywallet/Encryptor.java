...
public class Encryptor {
    ...
    byte[] encryptText(final String alias, final String textToEncrypt)
        ...
        utils.saveStringInSP(context, "encryption", Base64.encodeToString(encryption, Base64.DEFAULT));
        utils.saveStringInSP(context, "encryptionIv", Base64.encodeToString(iv, Base64.DEFAULT));
        return encryption;
    }
